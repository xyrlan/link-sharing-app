...
export default function LinksMenu({ addNewLink, fields, selectedPlatforms, handlePlatformChange, handleSubmit, onSubmit, Links, register, removeLink }: any) {


    return (
        <div className="sm:py-6 px-6 lg:px-8 shadow sm:w-2/3 max-h-full max-sm:w-full relative">
            <div>
